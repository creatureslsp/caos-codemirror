...
// outside this pnpm workspace root as a sibling directory. @creatures-codemirror/engine
...
// bench/index.html is a standalone benchmark page alongside the main demo app.
